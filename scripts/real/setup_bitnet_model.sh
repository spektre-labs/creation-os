...
echo ""
echo "Optional σ from perplexity (slow; second process per reply):"
echo "  export CREATION_OS_BITNET_USE_PPL=1"
echo "  # uses build/bin/llama-perplexity beside llama-cli unless CREATION_OS_BITNET_PERPLEX_EXE is set"
