...
#
# Fetch Qwen3.5-9B Q4_K_M GGUF into ./models/
# Canonical filename: models/qwen3.5-9b-Q4_K_M.gguf (matches bitnet_server defaults).
set -euo pipefail
...
CANON="qwen3.5-9b-Q4_K_M.gguf"
HF_REPO="${COS_QWEN35_9B_REPO:-unsloth/Qwen3.5-9B-GGUF}"
HF_FILE="${COS_QWEN35_9B_FILE:-Qwen3.5-9B-Q4_K_M.gguf}"
...
echo "Downloading Qwen3.5-9B Q4_K_M ($HF_REPO) ..."
