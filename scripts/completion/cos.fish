...
complete -c cos -n "not __fish_seen_subcommand_from $cos_subs" -a "sigma"     -d "run every kernel self-test v60 → v80"
...
complete -c cos -n "not __fish_seen_subcommand_from $cos_subs" -a "cx"        -d "σ-Cortex — hypervector-space neocortical reasoning plane (v80)"
complete -c cos -n "not __fish_seen_subcommand_from $cos_subs" -a "cortex"    -d "long form of cx (v80)"
complete -c cos -n "not __fish_seen_subcommand_from $cos_subs" -a "reason"    -d "alias of cx (v80)"
complete -c cos -n "not __fish_seen_subcommand_from $cos_subs" -a "neo"       -d "alias of cx (v80)"
