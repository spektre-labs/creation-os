...
_cos() {
    ...
    subcmds=(
        ...
        'sigma:run every kernel self-test v60 → v80 and print verdicts'
        ...
        'sm:σ-Simulacrum — hypervector-space simulation substrate (v79)'
        'sim:alias of sm (v79 σ-Simulacrum)'
        'simulacrum:long form of sm (v79 σ-Simulacrum)'
        'world:alias of sm (v79 σ-Simulacrum)'
        'cx:σ-Cortex — hypervector-space neocortical reasoning plane (v80)'
        'cortex:long form of cx (v80 σ-Cortex)'
        'reason:alias of cx (v80 σ-Cortex)'
        'neo:alias of cx (v80 σ-Cortex)'
