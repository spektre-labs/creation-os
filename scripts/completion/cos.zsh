...
_cos() {
    ...
    subcmds=(
        ...
        'verify:Verified-Agent (v57) rollup across all sixteen kernels'
        'chace:CHACE-class 12-layer capability-hardening gate'
        'sigma:run every kernel self-test v60 → v76 and print verdicts'
        ...
        'decide:16-bit composed decision — emits one JSON verdict'
