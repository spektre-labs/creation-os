...
**Optional (not `merge-gate`):** σ / MCP / M4 / RTL labs — [σ labs (v31–v51)](#sigma-labs-v31-v40), `make check-mcp`, `make check-native-m4`, `make formal-sby-v37`, `make verify`, `make red-team`, `make certify`, `make v50-benchmark`, `make check-v51`, etc.; see `make help`.
