...
Adversarial prompt matrix: `tests/stress/break_it.csv` (35 rows as of 2026-04).

Supplemental slice (same schema; latest adversarial additions): `benchmarks/break_it/adversarial_prompts.csv`.
