...
harden: standalone-v57-hardened standalone-v58-hardened standalone-v59-hardened standalone-v60-hardened standalone-v61-hardened standalone-v62-hardened
	@echo "harden: OK (v57 / v58 / v59 / v60 / v61 / v62 rebuilt with OpenSSF 2026 flags + M4 branch-protection)"
...
sanitize: asan-v58 asan-v59 asan-v60 ubsan-v60 asan-v61 ubsan-v61 asan-v62 ubsan-v62
	@echo "sanitize: OK (ASAN v58/v59/v60/v61/v62 + UBSAN v60/v61/v62 all pass self-test under sanitizer)"
